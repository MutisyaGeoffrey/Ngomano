        ...
        >
          ...
          <div className="flex flex-wrap gap-4" data-aos="fade-up" data-aos-delay="500">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 text-white font-body font-bold rounded-xl border border-white/30 backdrop-blur-md hover:bg-white/20 hover:scale-105 hover:shadow-xl transition-all duration-300"
            >
