      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4 font-body">
              <a href="mailto:ngomannex@gmail.com" className="block text-muted-foreground hover:text-primary font-medium transition-colors break-all p-2 rounded-lg hover:bg-primary/5">
                ngomannex<br/>@gmail.com
              </a>
              <div className="w-12 h-px bg-border mx-auto my-3" />
